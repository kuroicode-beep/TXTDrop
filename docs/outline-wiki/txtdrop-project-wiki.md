...
| 항목 | 내용 |
|------|------|
| 현재 버전 | v0.7 + AI 기억 캡처(옵트인), 2026-07-10 |
| 대상 플랫폼 | Windows |
| 실행 형태 | 시스템 트레이 상주 앱 |
...
엔트리포인트, 설정/DB, 클립보드 저장, Ollama 연동, TTS 낭독(자동 기동 포함), AI 기억 캡처, 중복제거, 트레이/UI, 빌드/배포 규칙을 구현 기준으로 정리한다.
...
버전별 마일스톤과 2026-07-08 TTS 낭독·중복제거 추가, 2026-07-09 TXTBrain 연계, 2026-07-10 TTS 자동 기동·AI 기억 캡처까지 추적한다.

### 완료보고서 인덱스

빌드 검증, 안정화, TTS 낭독·자동 기동, 중복제거, TXTBrain 연계, AI 기억 캡처 등 완료 보고서의 위치와 검색 키워드를 관리한다.
