...
_STRINGS: dict[str, dict[str, str]] = {
    "ko": {
        ...
        "lbl_memory_token":       "AI 기억 페어링 토큰",
        "hint_memory_token":      "TXTAIMemory 설정 → \"페어링 토큰 발급\"에서 복사해 붙여넣으세요. 비워두면 토큰 발급 전에는 계속 동작하지만, 발급 후에는 401 오류로 저장이 실패합니다.",
    ...
    "en": {
        ...
        "lbl_memory_token":       "AI Memory Pairing Token",
        "hint_memory_token":      "Copy from TXTAIMemory Settings → \"Issue Pairing Token\" and paste here. Leave blank to keep working until a token is issued there; after that, saves will fail with a 401 error.",
